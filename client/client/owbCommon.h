...
#define CANVAS_RECT CGRectMake(0,0, SCREEN_HEIGHT*MAX_ZOOM_SCALE , SCREEN_WIDTH*MAX_ZOOM_SCALE)
#define CANVAS_SIZE CGSizeMake(SCREEN_HEIGHT * MAX_ZOOM_SCALE, SCREEN_WIDTH * MAX_ZOOM_SCALE)
